...
function(mns, uns, onetwo, fudge=100, ret2=FALSE, ...){
   ...
   mnsc[onetwo=='I' ,] <- normalizeQuantiles(mnsc[onetwo=='I', , drop = FALSE])
   mnsc[onetwo=='II',] <- normalizeQuantiles(mnsc[onetwo=='II', , drop = FALSE])

   unsc[onetwo=='I' ,] <- normalizeQuantiles(unsc[onetwo=='I', , drop = FALSE])
   unsc[onetwo=='II',] <- normalizeQuantiles(unsc[onetwo=='II', , drop = FALSE])
